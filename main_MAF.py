...
from azure.ai.projects.aio import AIProjectClient # Azure Foundry: https://learn.microsoft.com/en-us/azure/ai-services/foundry/quickstarts/get-started?tabs=python

from agent_framework import ChatAgent, AgentResponseUpdate  #, Tool, ToolInput, ToolOutput
from agent_framework.openai import OpenAIResponsesClient, OpenAIChatClient  # OpenAIChatModel
...
if __name__ == "__main__":
    serve(entities=[ChatAgent], auto_open=True, tracing_enabled=True)
    asyncio.run(main())
